	...
	\end{itemize}
		...
		\section{Baza podataka}
			...
			\subsection{Dijagram baze podataka}
				...
				\begin{figure}[H]
					\includegraphics[width=\textwidth]{slike/dijagramBaze.PNG} %veličina u odnosu na širinu linije
					\caption{Dijagram baze podataka}
					\label{fig:dijagramBaze} %label mora biti drugaciji za svaku sliku
				\end{figure}
