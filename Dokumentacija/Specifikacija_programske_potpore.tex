	...
	\section{Funkcionalni zahtjevi}
			...
			\subsection{Obrasci uporabe}
				...
				\subsubsection{Opis obrazaca uporabe}
					...
					\noindent \underbar{\textbf{UC6 - Stvaranje profila nove tvrtke}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC7 - Promijena podataka tvrtke}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC8 - Brisanje tvrtke iz sustava}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC9 - Primanje obavijesti}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: } Korisnik (Zaposlenik, Revizor, Računovođa, Direktor)
					...
					\noindent \underbar{\textbf{UC10 - Pregledavanje statistike zaposlenika tvrtke}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC11 - Pregled svih dokumenata}}
					\begin{packed_item}
						
						\item \textbf{Glavni sudionik: } Računovođa, Direktor, Revizor, Zaposlenik
						...
						\item[] \begin{packed_enum}
							...
							\item Aktor odabire pregled popisa svih dokumenata za koje aktor ima dopuštenje 
							\item Sustav prikazuje popis svih dopuštenih dokumenata
					...
					\noindent \underbar{\textbf{UC12 - Objava dokumenta na društvene mreže}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC13 - Pregledavanje dokumenata}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Aktor odabire opciju za prikaz svih dopuštenih dokumenata
					...
					\noindent \underbar{\textbf{UC14 - Arhiviranje dokumenata}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Računovođa otvara listu potpisanih dokumenata
					...
					\noindent \underbar{\textbf{UC15 - Potpisivanje dokumenata}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC16 - Slanje dokumenta na potpis}}
					\begin{packed_item}
						...
						\item[] \begin{packed_enum}
							...
							\item Računovođa odabire opciju za prikaz nepotpisanih dokumenata
					...
					\noindent \underbar{\textbf{UC17 - Učitavanje slika dokumenata}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC18 - Digitializacija dokumenta}}
					\begin{packed_item}
					...
					\noindent \underbar{\textbf{UC19 - Detekcija dokumenta sa slike}}
					\begin{packed_item}
