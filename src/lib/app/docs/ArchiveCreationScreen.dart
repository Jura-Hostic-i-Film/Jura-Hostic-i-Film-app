...
class ArchiveCreationScreenState extends State<ArchiveCreationScreen> {
  ...
  Widget build(BuildContext context) {
            ...
            child: Column(
              ...
              children: [
                ...
                Padding(
                  ...
                  child: ParticipantDisplayable(role: "Revidirao:", user: archive.audited),
                ),
    ...
    final int documentId = ModalRoute.of(context)!.settings.arguments as int;

    return FutureBuilder(
        future: apiServiceProvider.getAuditById(),
